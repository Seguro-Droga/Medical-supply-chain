...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be swastha-blockchain@0.0.7',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('swastha-blockchain@0.0.7.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('content component should be loadable',() => {
    ...
    it('content table should have 6 columns',() => {
      page.navigateTo('/content');
